...
import pl.kozervar.exap.data.MemberRepository;
import pl.kozervar.exap.model.Member;
import pl.kozervar.exap.service.MemberRegistration;
...
public class MemberResourceRESTService {
	...
	private Response.ResponseBuilder createViolationResponse(
		...
		log.debug("Validation completed. violations found: "
		        + violations.size());
